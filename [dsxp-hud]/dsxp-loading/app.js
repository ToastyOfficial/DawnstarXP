/* Floh is you want regular text uncomment the below line also uncomment in config */
...
$(function () {
    ...
    function appen(i) {
        document.getElementById("nsrp").innerHTML= document.getElementById("nsrp").innerHTML + `<img width="100%"height="100%" src=imgs/${i}>`;
}
    function random(pp) {
        return Math.floor(Math.random() * pp);
    }
    var img = $('div#nsrp img');
    var len = img.length;
