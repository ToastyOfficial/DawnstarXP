...
this script supports 3 postal maps. From what I have seen, these are the most popular
...
To setup the postal map rename your file from what it was to `postals.json`
