...
local screenPosX = 0.17                    -- X coordinate (top left corner of HUD)
local screenPosY = 0.802                    -- Y coordinate (top left corner of HUD)
...
local speedColorText = {180, 180, 180}      -- Color used to display speed label text
...
local locationColorText = {180, 180, 180}   -- Color used to display location and time
...
Citizen.CreateThread(function()
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            exports.nsrp_hud:updateVehInfo(heading, speed, zoneNameFull, streetName)
            -- Update fuel when in a vehicle (uncomment & update for your fuel system)
          ...
          --[[  if pedInVeh then
                ...
                if fuelShowPercentage then
                    ...
                    --Display remainign fuel in literal
...
-- function getIsPedInVehicle()
--   if IsPedInAnyVehicle(PlayerPedId()) then
--     exports.nsrp_hud:showVehHud(true)
--   else
--     exports.nsrp_hud:showVehHud(false)
--   end
-- end
--
...
RegisterNetEvent('setVehicleHUD')
AddEventHandler('setVehicleHUD', function(bool)
  exports.nsrp_hud:showVehHud(bool)
end)
