...
local function debugPrint(text)
    if DSMenu.debug then
        Citizen.Trace('[DSMenu] '..tostring(text))
    end
end
...
function DSMenu.CreateMenu(id, title)
    -- Default settings
    menus[id] = { }
    menus[id].title = title
    menus[id].subTitle = 'Select a Traffic Management Option.'
...
function DSMenu.CreateSubMenu(id, parent, subTitle)
    if menus[parent] then
        DSMenu.CreateMenu(id, menus[parent].title)
...
function DSMenu.CurrentMenu()
    return currentMenu
end


function DSMenu.OpenMenu(id)
    if id and menus[id] then
...
function DSMenu.IsMenuOpened(id)
    return isMenuVisible(id)
end


function DSMenu.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function DSMenu.Button(text, subText)
...
function DSMenu.MenuButton(text, id)
    if menus[id] then
        if DSMenu.Button(text) then
            setMenuVisible(currentMenu, false)
...
function DSMenu.CheckBox(text, bool, callback)
    local checked = 'Off'
    if bool then
        checked = 'On'
    end

    if DSMenu.Button(text, checked) then
        bool = not bool
...
function DSMenu.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if DSMenu.Button(text, selectedItem) then
...
function DSMenu.SetMenuWidth(id, width)
    setMenuProperty(id, 'width', width)
end


function DSMenu.SetMenuX(id, x)
    setMenuProperty(id, 'x', x)
end


function DSMenu.SetMenuY(id, y)
    setMenuProperty(id, 'y', y)
end


function DSMenu.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, 'maxOptionCount', count)
end


function DSMenu.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, 'titleColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleColor.a })
end
 
 
function DSMenu.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, 'titleBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleBackgroundColor.a })
end


function DSMenu.SetSubTitle(id, text)
    setMenuProperty(id, 'subTitle', string.upper(text))
end


function DSMenu.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, 'menuBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
end


function DSMenu.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, 'menuTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuTextColor.a })
end

function DSMenu.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, 'menuSubTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuSubTextColor.a })
end

function DSMenu.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, 'menuFocusColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuFocusColor.a })
end


function DSMenu.SetMenuButtonPressedSound(id, name, set)
